...
class XWiki20Renderer(BaseRenderer[str]):
    ...
    firstChildOfListItems: list[block_token.BlockToken]
    ...
    def render_x_wiki_block_macro_start(self, token: span_token.XWikiBlockMacroStart) -> str: ...
    def render_x_wiki_block_macro_end(self, token: span_token.XWikiBlockMacroEnd) -> str: ...
