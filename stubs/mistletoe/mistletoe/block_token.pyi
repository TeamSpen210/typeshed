...
from typing import Any, ClassVar, NoReturn, Optional, Protocol, overload
...
def add_token(token_cls: type[BlockToken], position: int = 0) -> None: ...
def remove_token(token_cls: type[BlockToken]) -> None: ...
...
class BlockToken(token.Token):
    ...
    @staticmethod
    def read(lines: ParseBuffer) -> Any: ...
...
class Heading(BlockToken):
    ...
    @classmethod
    def read(cls, lines: ParseBuffer) -> tuple[int, list[str]]: ...
...
class SetextHeading(BlockToken):
    ...
    @classmethod
    def read(cls, lines: ParseBuffer) -> NoReturn: ...
...
class Quote(BlockToken):
    ...
    @classmethod
    def read(cls, lines: ParseBuffer) -> ParseBuffer: ...
    @staticmethod
...
class Paragraph(BlockToken):
    ...
    children: list[SpanToken]
    @overload
    def __new__(cls, lines: SetextHeading) -> SetextHeading: ...  # type: ignore[misc]
    @overload
...
class BlockCode(BlockToken):
    ...
    def start(line: str) -> bool: ...
    @classmethod
    def read(cls, lines: ParseBuffer) -> list[str]: ...
    @staticmethod
...
class CodeFence(BlockToken):
    ...
    def start(cls, line: str) -> bool: ...
    @classmethod
    def read(cls, lines: ParseBuffer) -> tuple[list[str], tuple[int, str, str]]: ...
...
_ListMarker: TypeAlias = Optional[tuple[int, str, str]]
...
class List(BlockToken):
    ...
    @classmethod
    def read(cls, lines: Paragraph) -> list[tuple[ParseBuffer, int, str]]: ...  # type: ignore[override]
    @staticmethod
